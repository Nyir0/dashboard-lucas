...
import StackedBarCharts from './StackedChart'
        ...
        <>
            <div className="flex flex-col gap-8">
                <div className="flex flex-col pb-8 max-sm:pb-16 relative overflow-hidden">
                    ...
                    <section className='flex max-sm:flex-col hadow-[0_5px_20px_5px_rgba(0,0,0,0.3)] w-[97%] mx-2 rounded-3xl h-[55vh] max-sm:h-[85vh]'>
