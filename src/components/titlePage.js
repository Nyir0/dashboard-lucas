    ...
    return(
        <>
            <div className="flex flex-col gap-8">
                <div className="flex flex-col pb-8 xl:pb-16 relative overflow-hidden">
                        ...
                        <div className='flex flex-col w-2/3'>
                            ...
                            {/* <img src="img/man-chart.svg" alt="" /> */}
                                <section className='flex w-full justify-around'>
                                    <span className="flex space-x-3 transform transition-transform hover:scale-105 cursor-pointer">
                                    ...
                                    <span href="#" className="flex space-x-3 transform transition-transform hover:scale-105 cursor-pointer">
                                        <span className="flex flex-col items-center">
                    ...
                    <section className='shadow-[0_5px_20px_5px_rgba(0,0,0,0.3)] w-[95vw] mx-2 rounded-xl'>
                        <Grafico/>
                    </section>
                    <Table/>
                </div>
