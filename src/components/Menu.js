        ...
        <section>
            ...
            <div className="absolute menu w-[20vw] pr-1 overflow-y-scroll h-[92.5vh] text-[var(--color-text1)] pb-3">
                ...
                <div className="flex items-center justify-between py-2 cursor-pointer menu-unique ">
                    ...
                    <span class="mr-4 p-1 text-xs bg-red-200 text-red-400 w-6 text-center">
                        34
                    </span>
                </div>
                <div className="flex items-center py-2 cursor-pointer menu-unique ">
                ...
                <div className="flex items-center py-2 cursor-pointer menu-unique justify-between">
                    ...
                    <span class="mr-4 p-1 text-xs bg-blue-200 text-blue-400 w-6 text-center">
                        6
                    </span>
                </div>
                <div className="sub-menu">
                    ...
                    <div className="in-menu">
                        <span>Empty</span>
                        <div className="flex flex-col items-center py-2 cursor-pointer justify-between w-11/12">
                            <div class="flex items-center w-full">
                                <span>Simple</span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" className="navigation__item__chevron icon icon--feather arrow"><polyline points="9 18 15 12 9 6"></polyline></svg>
                            </div>
                            <div class="submenu flex flex-col items-center justify-between w-11/12">
                                <div className="in-menu">
