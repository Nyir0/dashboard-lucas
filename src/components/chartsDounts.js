export function Dounts() {
    ...
    return (
        <>
            <div className="md:flex xl:flex-col md:space-x-8 xl:space-x-0 space-y-8 md:space-y-0 xl:space-y-8 items-start order-4 xl:order-none col-span-6 xl:col-span-1">
                <div className="card md:w-1/2 xl:w-full">
